...
final class ImmersiveCatalystClientTest {
    ...
    static boolean tick(Minecraft minecraft) {
        ...
        var mold = BuiltInRegistries.ITEM.get(new ResourceLocation("immersiveengineering:mold_plate"));
        ...
        for (Object recipe : recipes) {
            ...
            require(input && !catalyst, "Pinned IE mold role changed");
            plateLayouts++;
        }
        ...
        for (int flags : new int[]{0, 16}) {
            ...
            require(needsMold == true, "Unexpected mold requirement");
            ...
            require(pattern.getInputs().length == 2, "Unexpected input count");
            var output = pattern.getOutputs()[0];
            require(output.amount() == 1 && output.what().equals(AEItemKey.of(
                    BuiltInRegistries.ITEM.get(new ResourceLocation("immersiveengineering:plate_iron")))),
        ...
        AeAllPattern.LOGGER.info("IE_CATALYST_CLIENT_TEST_PASSED: plateLayouts={}, encoded={}, moldRole=INPUT",
