...
class MasterfulMachineryBridgeTest {
    private static final ResourceLocation A = new ResourceLocation("pack_a", "smelter");
    private static final ResourceLocation B = new ResourceLocation("pack_b", "smelter");
